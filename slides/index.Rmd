...
# Some high profile examples of software
...
- Software is a legitimate form of research contribution
...
- R's model syntax, how this maps to model algebra
- ggplot code
- leafletJS
...
- Maths example
- square root - we don't care how it happens (Newton Raphson? Quake fast square root?), we just care that it does
- ggplot?
